...
document.getElementById('uUXneOHg1g').addEventListener('slide.bs.carousel', function (e) {
  let captions = document.querySelectorAll('.caption-bg');
  captions.forEach(c => c.style.opacity = '0'); // hide before slide
});

document.getElementById('uUXneOHg1g').addEventListener('slid.bs.carousel', function (e) {
  let activeCaption = e.relatedTarget.querySelector('.caption-bg');
  if (activeCaption) {
    activeCaption.style.opacity = '1'; // show after slide
  }
});
